...
public class GuiAEManager {
    ...
    public static void prepareComponent(ComponentClassNamesE name) {
        ...
        if (ActiveToolsV2.getToolState(ToolsE.newComp)) {
            return;
        }
        updateToolTextures();
    ...
    private static void addComponentControlBtn() {
        if (!componentTemp.getDigComponent().isSpecial()) {
            return;
        }
    ...
    public static void CursorCross() {

        workspace.setCursor(Cursor.getPredefinedCursor(Cursor.CROSSHAIR_CURSOR));
    }

    public static void CursorDefault() {

        workspace.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }

    public static JPanel getWorkspace() {
        return workspace;
    }
